...
public class Person
{
    ...
    /**
     * Creates a new person with name n and date of birth d creates empty morale
     * manager
     * 
    ...
    /**
     * Creates a new person with name n and date of birth d creates empty morale
     * manager uses parsed string to create the date object
     * 
     * @param n the name of the person
     * 
     * @param d the person's date of birth
    ...
    public Person(String n, String d, ArrayList<Modifier> m )
    {
	name = n;
	try
	{
    ...
    /**
     * Creates a new person with name n and date of birth d uses parsed list of
     * modifiers to create morale manager
     * 
     * @param n the name of the person
     * 
     * @param d the person's date of birth
